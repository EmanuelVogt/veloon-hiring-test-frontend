            ...
            <div className="space-y-4">
              ...
              <Calendar
                ...
                classNames={{
                  ...
                  caption:
                    "flex justify-center pt-2 relative items-center dark:text-gold",
                  caption_label: "text-base font-medium",
                  nav: "space-x-1 flex items-center",
                  nav_button:
                    "h-8 w-8 bg-transparent p-0 hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-gold dark:hover:text-white rounded-full transition-colors duration-200",
                  nav_button_previous: "absolute left-2",
                  nav_button_next: "absolute right-2",
                  table: "w-full border-collapse space-y-1",
                  head_row: "flex w-full",
                  head_cell:
                    "text-muted-foreground rounded-md w-9 font-normal text-[0.9rem] dark:text-gray-400 flex-1",
                  ...
                  day_selected:
                    "bg-navy text-white hover:bg-navy/90 hover:text-white dark:bg-gold dark:text-navy dark:hover:bg-gold/90 font-medium",
                  day_today:
                    "bg-accent text-accent-foreground font-medium border-2 border-navy/20 dark:border-gold/20",
